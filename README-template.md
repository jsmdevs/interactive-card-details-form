...
- Recibir mensajes de error cuando se envíe el formulario si:
  ...
  - El número de tarjeta, la fecha de vencimiento o los campos CVC están en formato incorrecto
- Vea el diseño óptimo dependiendo del tamaño de la pantalla de su dispositivo
- Consulte los estados Hover, Active y Focus para elementos interactivos en la página
