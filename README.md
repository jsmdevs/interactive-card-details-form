...
- Actualice los detalles de la tarjeta a medida que el usuario llena los campos
- Validar los campos de formulario cuando se envía el formulario
- Si no hay errores, muestre el estado completo
- Restablezca el formulario cuando el usuario hace clic "Continúe" en el estado completado
